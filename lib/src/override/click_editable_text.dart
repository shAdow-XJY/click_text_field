...
import 'click_editable.dart' as clickEditable;
...
typedef EditableTextContextMenuBuilder = Widget Function(
    ...
    ClickEditableTextState editableTextState,
    );
...
///  * [ClickEditableText], which is a raw region of editable text that can be
...
class TextEditingController extends ValueNotifier<TextEditingValue> {
  ...
  TextSpan buildTextSpan({required BuildContext context, TextStyle? style , required bool withComposing}) {
    ...
    // be thrown and this ClickEditableText will be built with a broken subtree.
...
/// Toolbar configuration for [ClickEditableText].
///
/// Toolbar is a context menu that will show up when user right click or long
/// press the [ClickEditableText]. It includes several options: cut, copy, paste,
/// and select all.
///
/// [ClickEditableText] and its derived widgets have their own default [ToolbarOptions].
...
class ToolbarOptions {
  ...
  ///
  /// If [ClickEditableText.readOnly] is set to true, cut will be disabled regardless.
  ///
  /// Defaults to false. Must not be null.
  final bool cut;
  ...
  ///
  /// If [ClickEditableText.readOnly] is set to true, paste will be disabled regardless.
  ///
  /// Defaults to false. Must not be null.
  final bool paste;
...
/// See also:
///
/// * [ClickEditableText.contentInsertionConfiguration]
...
/// ClickEditableText receives focus. For example, providing iOS's "emergencyCall"
...
///
/// {@template flutter.widgets.ClickEditableText.lifeCycle}
/// ## Lifecycle
///
...
class ClickEditableText extends StatefulWidget {
  ...
  ///
  /// The cursor refers to the blinking caret when the [ClickEditableText] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  /// [CupertinoTextField], and [ClickEditableText].
  ///
  ...
  ///
  /// The [ClickEditableText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [ClickEditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [ClickEditableText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [ClickEditableText], which
  ...
  /// {@template flutter.widgets.ClickEditableText.onChanged}
  ...
  ///
  /// The [mouseCursor] is the only property of [ClickEditableText] that controls the
  ...
  /// testing purposes.
  ///
  /// It does not affect the necessity to focus the ClickEditableText for the cursor
  ...
  ///
  /// When null, this widget's [ClickEditableTextState] will be used as the
  ...
  /// [ClickEditableText].
  ///
  /// If a restoration id is provided, the [ClickEditableText] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [ClickEditableText] is the
  ...
  /// {@template flutter.widgets.ClickEditableText.contextMenuBuilder}
  ...
  /// {@template flutter.widgets.ClickEditableText.spellCheckConfiguration}
  ...
  ///
  /// For example, [ClickEditableText] uses this to generate the default buttons for
  /// its context menu.
  ///
  /// See also:
  ///
  /// * [ClickEditableTextState.contextMenuButtonItems], which gives the
  ///   [ContextMenuButtonItem]s for a specific ClickEditableText.
  ...
  // Infer the keyboard type of an `ClickEditableText` if it's not specified.
  static TextInputType _inferKeyboardType({
    ...
    // with the content type. To get autofill to work by default on ClickEditableText,
  ...
  @override
  ClickEditableTextState createState() => ClickEditableTextState();
...
/// State for a [ClickEditableText].
class ClickEditableTextState extends State<ClickEditableText> with AutomaticKeepAliveClientMixin<ClickEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<ClickEditableText>, TextSelectionDelegate, TextInputClient implements AutofillClient {
  Timer? _cursorTimer;
  ...
  /// {@template flutter.widgets.ClickEditableText.getAnchors}
  ...
  /// Returns the [ContextMenuButtonItem]s representing the buttons in this
  /// platform's default selection menu for [ClickEditableText].
  ///
  /// See also:
  ///
  /// * [ClickEditableText.getEditableButtonItems], which performs a similar role,
  ///   but for any editable field, not just specifically ClickEditableText.
  ...
  List<ContextMenuButtonItem> get contextMenuButtonItems {
    return buttonItemsForToolbarOptions() ?? ClickEditableText.getEditableButtonItems(
  ...
  @override
  void didUpdateWidget(ClickEditableText oldWidget) {
  ...
  /// update via [updateEditingValue], or when [ClickEditableText] calls
  ...
  void updateEditingValue(TextEditingValue value) {
    ...
    // input plugin. The [ClickEditableText] may not have the focus or an open input
    // connection, as autofill can update a disconnected [ClickEditableText].
  ...
  void performAction(TextInputAction action) {
    ...
    // ignore: switch_case_completes_normally
      ...
      // If this is a multiline ClickEditableText, do nothing for a "newline"
  ...
  ///
  /// Throws an error in debug mode if this [ClickEditableText] is not in a batch
  /// edit.
  void endBatchEdit() {
    _batchEditDepth -= 1;
    assert(
  ...
  // the main axis.
  //
  // If this is a multiline ClickEditableText (which means the Editable can only
  ...
  // ClickEditableText, allowing it to distinguish between internal and external
  // focus changes.
  ...
  void _handleSelectionChanged(TextSelection selection, SelectionChangedCause? cause) {
    ...
    // text of [ClickEditableText] is updated at the same time as the selection is
    ...
    // ClickEditableText except for those triggered by a keyboard input.
    // Typically ClickEditableText shouldn't take user keyboard input if
    // it's not focused already. If the ClickEditableText is being
  ...
  void _startCursorBlink() {
    ...
    _cursorTimer?.cancel();
    _cursorBlinkOpacityController.value = 1.0;
    if (ClickEditableText.debugDeterministicCursor) {
      return;
    }
  ...
  @override
  String get autofillId => 'ClickEditableText-$hashCode';
  ...
  Widget build(BuildContext context) {
    ...
    return _CompositionCallback(
      ...
      child: TextFieldTapRegion(
        ...
        debugLabel: kReleaseMode ? null : 'ClickEditableText',
        child: MouseRegion(
                      ...
                      child: Semantics(
                        ...
                        child: _ScribbleFocusable(
                          ...
                          child: _Editable(
                            ...
                            showCursor: ClickEditableText.debugDeterministicCursor
...
class _Editable extends MultiChildRenderObjectWidget {
  ...
  @override
  clickEditable.ClickRenderEditable createRenderObject(BuildContext context) {
    return clickEditable.ClickRenderEditable(
      text: inlineSpan,
...
/// e.g. password input in [ClickEditableText]. If you are handling text that may
...
class _DeleteTextAction<T extends DirectionalTextEditingIntent> extends ContextAction<T> {
  ...
  final ClickEditableTextState state;
